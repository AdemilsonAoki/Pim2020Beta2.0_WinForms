...
namespace PizzariaWinForm.Formularios
{
    public partial class frmCadastroProduto : Form
    {
        ...
        private void RecebendoValor()
        {
            ...
            prod.Porcentagem = double.Parse(txtPorcentagem.Text);
           
        }
        public void RecebendoValorDgv(string id, string descricao, string preco, string precoVenda, string quantidade, string fornecedor, string categoria, string porcentagem)
        {
        ...
        {
            if (txtNome.Text != " " && txtPorcentagem.Text != " " && txtPrecoCusto.Text != "" && txtPrecoVenda.Text != "" && txtQuantidade.Text != "" && cmbCategoria.Text != "" && cmbFornecedor.Text != "")
            {
        ...
        private void btnAlterar_Click(object sender, EventArgs e)
        {
            ...
            var result = MessageBox.Show("Produto , Alterado com sucesso!", MessageBoxButtons.OK.ToString());
        ...
        {
            CodigosGerais codigos = new CodigosGerais();
            codigos.Moeda(txtPrecoCusto);
        }
    }
}
